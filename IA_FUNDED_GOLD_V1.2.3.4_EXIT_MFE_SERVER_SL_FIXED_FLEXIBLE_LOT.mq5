...
#property description "IA FUNDED GOLD V1.2.3.4 FLEXIBLE LOT - mesma logica operacional, com FixedLot liberado conforme limites do simbolo."
...
void UpdatePanel()
{
   ...
   string panel =
      EA_NAME + "\n" +
      "Versao: V1.2.3.4 EXIT MFE SERVER SL FIXED + FLEXIBLE LOT\n" +
      "Simbolo: " + _Symbol + "\n" +
